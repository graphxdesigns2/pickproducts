    ...
    <div className={`modal-overlay${isOpen ? " open" : ""}`}>
      <div className="modal">
        ...
        <div className="modal-info">
          ...
          <h2>{p.name}</h2>
          <div className="card-rating">★ {p.rating} <span style={{ color: "#a3adbf" }}>({p.reviews} reviews)</span></div>
            ...
            <div>
              ...
              <div className="size-opts">
                {p.sizes.map((s) => (
                  <button
                    key={s}
                    className={`size-opt${s === size ? " selected" : ""}`}
                    onClick={() => setSize(s)}
                  >
                    {s}
                  </button>
          ...
          <div>
            ...
            <div className="qty-row">
              ...
              <span className="stock-note">✓ In stock, ships in 1–2 days</span>
            </div>
          </div>
