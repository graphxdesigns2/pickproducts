...
export function GooglePayMark() {
  return (
    <svg width="56" height="20" viewBox="0 0 56 20" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="17" y="14" fontFamily="Roboto, sans-serif" fontWeight="500" fontSize="13" fill="currentColor">Pay</text>
    </svg>
  );
}
...
export function ApplePayMark() {
  return (
    <svg width="50" height="20" viewBox="0 0 50 20" xmlns="http://www.w3.org/2000/svg">
      <g transform="translate(0, 3) scale(0.6)" fill="currentColor">
      ...
      <text x="12" y="14" fontFamily="-apple-system, BlinkMacSystemFont, sans-serif" fontWeight="600" fontSize="13" fill="currentColor">Pay</text>
    </svg>
  );
}
